...
const minimap = readFileSync(new URL("../src/rendering/minimap-renderer.js", import.meta.url), "utf8");
...
assert.match(minimap, /function drawLegend\(/, "Expected categorized minimap markers.");
