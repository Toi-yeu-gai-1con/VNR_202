...
const TRANSITIONS = Object.freeze({
  ...
  [SCENES.LOADING]: new Set([SCENES.TRANSITION, SCENES.PLAYING, SCENES.START, SCENES.OPENING]),
  [SCENES.TRANSITION]: new Set([SCENES.LOADING, SCENES.PLAYING, SCENES.START]),
