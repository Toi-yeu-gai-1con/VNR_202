...
export const NARRATIVE_CHOICE_DEFINITIONS = Object.freeze({
  zone1: Object.freeze([
    ...
    },
    {
      ...
      options: Object.freeze([
        { id: "protect-common-path", label: "Trao báo và giữ con đường chung", branchFlags: { "zone1.compassRestored": true }, themeScores: { direction: 1 } },
        { id: "repair-harm", label: "Thừa nhận sai lầm và sửa chữa", branchFlags: { "zone1.repairAccepted": true }, endingRisks: { zone1: -1 }, themeScores: { direction: 1 } },
  ...
  zone2: Object.freeze([
    ...
    },
    {
      ...
      options: Object.freeze([
        { id: "unify", label: "Xác nhận nền tảng chung và thống nhất tổ chức", branchFlags: { "zone2.emblemStabilized": true }, themeScores: { unity: 1 } },
        { id: "repair-division", label: "Sửa sự chia rẽ bằng chứng cứ chung", branchFlags: { "zone2.repairedDivision": true }, endingRisks: { zone2: -1 }, themeScores: { unity: 1 }, corruption: 4 },
  ...
  zone3b: Object.freeze([
    ...
    },
    {
      ...
      options: Object.freeze([
        { id: "restore-unity", label: "Giữ mục tiêu thống nhất và đời sống người dân", branchFlags: { "zone3b.unityRestored": true }, themeScores: { unity: 1 } },
        { id: "repair-separation", label: "Sửa lựa chọn chia cắt bằng cách nối liên hệ", branchFlags: { "zone3b.repairedSeparation": true }, endingRisks: { zone3b: -1 }, themeScores: { unity: 1 }, corruption: 4 },
  ...
  zone4: Object.freeze([
    ...
    },
    {
      ...
      options: Object.freeze([
        { id: "put-producers-first", label: "Đặt đời sống người sản xuất ở trung tâm", branchFlags: { "zone4.producersFirst": true }, themeScores: { renewal: 1 } },
        { id: "repair-privilege", label: "Sửa phần đặc quyền gây bế tắc", branchFlags: { "zone4.repairedPrivilege": true }, endingRisks: { zone4: -1 }, themeScores: { renewal: 1 }, corruption: 4 },
